...
file_path<-"/Users/Amal/Box Sync/PSU/Summer 2018/Geoscience_Research/River network project/Analysis for Spill Paper/Cl_spill_whole/"

## Sourcing the modular functions for analysis
source(file = "/Users/Amal/Box Sync/PSU/Summer 2018/Geoscience_Research/River network project/BaSu_network_v15_modular_functions.R")
...
load(file = "~/Box Sync/PSU/Summer 2018/Geoscience_Research/River network project/NetStreams1998/shape.RData")
