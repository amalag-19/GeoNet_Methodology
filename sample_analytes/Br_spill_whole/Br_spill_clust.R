...
file_path<-"/storage/home/aua257/work/spill_datasets_run/Br_spill_whole/"
...
df_analyte_raw<-read.csv(file = paste0(file_path,"data/Br_data.csv"),stringsAsFactors = F)
str(df_analyte_raw)

## Preprocessing the analyte dataframe
df_analyte_preprocessed<-df_analyte_raw[,c(1,2,3)]
df_analyte_preprocessed$date<-as.Date(df_analyte_raw$Date,"%Y-%m-%d")
